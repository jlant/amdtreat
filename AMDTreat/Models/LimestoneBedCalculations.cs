...
{
    /// <summary>
    /// Calculations for Limestone Bed.
    /// 
    /// Unit Conversions:
    ...
    ///    1 acre = 43560 ft^2
    /// </summary>
    public static class LimestoneBedCalculations
    {
        ...
        /// <summary>
        /// Calculate the average limestone depth in feet.  Used in sizing calculation based on Alkalinity Generation.
        /// </summary>
        /// <param name="limestoneDepthUpstream">The depth of limestone upstream, a user define value</param>
        /// <param name="limestoneDepthDownstream">The depth of limestone downstream, a user define value</param>
        /// <returns></returns>
        public static double CalcLimestoneDepthAverage(double limestoneDepthUpstream, double limestoneDepthDownstream)
        {
            return (limestoneDepthUpstream + limestoneDepthDownstream) / 2;
        }
        ...
        {
            return freeboardTopDimension - (2.0 * pondInsideSlope * (freeboardDepth + freeStandingWaterDepth + limestoneDepth));
        }
        ...
        public static double CalcPondDepth(double freeboardDepth, double freeStandingWaterDepth, double limestoneDepth)
        {
            return freeboardDepth + freeStandingWaterDepth + limestoneDepth;
        }
        ...
        {
            return headerPipeLengthTotal / headerPipeSegmentLength;
        }
        ...
        public static double CalcLinerSlopeLength(double limestoneDepth, double freeStandingWaterDepth, double freeboardDepth, double pondInsideSlope)
        {
            double depthSum = limestoneDepth + freeStandingWaterDepth + freeboardDepth;
        ...
        public static double CalcExcavationVolume(double limestoneVolume, double freeStandingWaterVolume, double linerVolume)
        {
            return limestoneVolume + freeStandingWaterVolume + linerVolume;
        }
        ...
        /// <param name="limestonePlacementCost">The unit placement cost of limestone, a user specified value</param>
        /// <returns></returns>
